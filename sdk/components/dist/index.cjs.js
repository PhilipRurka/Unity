...
const Form = (_a) => {
  ...
  return /* @__PURE__ */ React__default["default"].createElement("form", __spreadValues$5({
...
const Label = (_a) => {
  ...
  return /* @__PURE__ */ React__default["default"].createElement("label", __spreadValues$3({
...
const Input = React.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React__default["default"].createElement("input", __spreadProps$1(__spreadValues$2({
    className: clsx__default["default"]("block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500", showErrorStyles ? "border-red-500" : "border-black")
  }, rest), {
    ref
  }));
});
...
const Select = React.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React__default["default"].createElement("select", __spreadProps(__spreadValues$1({
    id: "priority"
  }, rest), {
    ref
...
const CloseIcon$1 = ({ className, size }) => {
  ...
  return /* @__PURE__ */ React__default["default"].createElement("svg", {
    className: clsx__default["default"](className, width, height),
    clipRule: "evenodd",
    fillRule: "evenodd",
...
exports.Field = Field;
exports.Form = Form;
exports.HierarchyIcon = CloseIcon;
exports.Input = Input;
exports.Label = Label;
exports.Modal = Modal;
