    ...
    <div className="pointer-events-none fixed inset-0">
      ...
      <div
        className={clsx(
          ...
          'sm:max-h-modal sm:max-w-modal h-full w-full transition-opacity sm:rounded-xl',
          isSearchModalOpen ? 'pointer-events-auto opacity-100' : 'pointer-events-none opacity-0',
          backgroundStyle,
          backgroundStyle && 'bg-cover'
        )}
      >
        <div className={clsx('sm:max-h-modal h-full sm:rounded-xl', backgroundStyle && 'bg-white bg-opacity-90 py-8')}>
          ...
          <div className="h-search-results relative overflow-y-hidden">
